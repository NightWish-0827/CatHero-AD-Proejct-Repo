...
public class NightmareMonster : EnemyBase
{
    ...
    [SerializeField] private Vector3 attackPunch = Vector3.up * 0.15f;
    [SerializeField, Min(1)] private int attackPunchVibrato = 8;
    [SerializeField, Range(0f, 1f)] private float attackPunchElasticity = 0.8f;
    [SerializeField] private Ease attackPunchEase = Ease.OutQuad;
